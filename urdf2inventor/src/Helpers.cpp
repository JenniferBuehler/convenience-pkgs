...
bool urdf2inventor::helpers::fileExists(const char* file)
{
...
bool urdf2inventor::helpers::writeToFile(const std::string& content, const std::string& filename)
{
...
std::string urdf2inventor::helpers::packagePathToAbsolute(std::string& packagePath)
{
